...
export default function StylistIntegrationsPage() {
  return (
    <div className="space-y-8">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Verbinde externe Dienste mit deinem NICNOA-Account
            </p>
          </div>
        </div>
      </motion.div>
      ...
      <GoogleBusinessConnection basePath="/stylist" />
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          Bald verfügbar: Instagram, Facebook, TikTok und mehr
        </p>
      </motion.div>
    </div>
  )
