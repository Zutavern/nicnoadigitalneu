      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button variant="outline" asChild>
            <Link href="/stylist/marketing/social-media/calendar">
          ...
          <Card className="border-dashed border-2 border-purple-500/30 bg-gradient-to-br from-purple-500/5 to-pink-500/5">
            <CardContent className="py-12 text-center">
              ...
              <Button asChild className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600">
                <Link href="/stylist/marketing/social-media/accounts">
                  <Plus className="h-4 w-4 mr-2" />
                  Accounts verbinden
                </Link>
              </Button>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            ...
            <Button variant="outline" className="w-full justify-start" asChild>
              <Link href="/stylist/marketing/social-media/templates">
            ...
            <Button variant="outline" className="w-full justify-start" asChild>
              <Link href="/stylist/marketing/social-media/analytics">
