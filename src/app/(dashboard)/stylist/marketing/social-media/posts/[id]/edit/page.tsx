  ...
  const loadPost = async () => {
    try {
      ...
      if (!['DRAFT', 'SCHEDULED'].includes(post.status)) {
        ...
        router.push(`/stylist/marketing/social-media/posts/${post.id}`)
        return
      }
          ...
          <Button 
            ...
            onClick={() => {
              if (hasChanges) {
                ...
                router.push(`/stylist/marketing/social-media/posts/${resolvedParams.id}`)
              }
            }}
          >
      ...
      <AlertDialog open={confirmLeaveOpen} onOpenChange={setConfirmLeaveOpen}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction 
              onClick={() => router.push(`/stylist/marketing/social-media/posts/${resolvedParams.id}`)}
