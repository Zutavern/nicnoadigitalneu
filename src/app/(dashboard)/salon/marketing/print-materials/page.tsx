  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link href="/salon/marketing/print-materials/create">
          <Button>
              ...
              <Card key={material.id} className="group overflow-hidden">
                ...
                <CardContent className="p-4">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link href={`/salon/marketing/print-materials/${material.id}/edit`}>
                  ...
                  <div className="flex gap-2 mt-4">
                    <Link href={`/salon/marketing/print-materials/${material.id}/edit`} className="flex-1">
