...
export default function SocialMediaCalendar() {
  ...
  const createPostForDay = (day: Date) => {
    ...
    router.push(`/salon/marketing/social-media/posts/create?date=${dateStr}`)
  }
  ...
  const duplicatePost = async (postId: string) => {
    try {
      ...
      if (res.ok) {
        ...
        router.push(`/salon/marketing/social-media/posts/${newPost.id}/edit`)
      }
    } catch {
                        ...
                        <div className="flex items-start justify-between gap-2 mb-2">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem onClick={() => router.push(`/salon/marketing/social-media/posts/${post.id}`)}>
                                <Eye className="h-4 w-4 mr-2" />
                                Anzeigen
                              </DropdownMenuItem>
                              <DropdownMenuItem onClick={() => router.push(`/salon/marketing/social-media/posts/${post.id}/edit`)}>
