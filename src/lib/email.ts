...
export async function renderEmailPreview(
  ...
  const sampleData: Record<string, any> = {
    ...
    amount: '89,00 €',
    resetUrl: 'https://www.nicnoa.online/reset?token=xxx',
    verifyUrl: 'https://www.nicnoa.online/verify?token=xxx',
    dashboardUrl: 'https://www.nicnoa.online/dashboard',
    referralCode: 'MAXM2024',
    referralUrl: 'https://www.nicnoa.online/r/MAXM2024',
