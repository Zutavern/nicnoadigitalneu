    ...
    items: [
      {
        ...
        children: [
          ...
          { label: 'Preispläne', href: '/admin/plans', icon: Package },
          { label: 'Billing-Einstellungen', href: '/admin/billing-settings', icon: Settings },
          { label: 'Coupons', href: '/admin/coupons', icon: Tag },
          { label: 'AI-Modelle', href: '/admin/ai-models', icon: Brain },
