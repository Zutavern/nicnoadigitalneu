...
interface SocialMediaDashboardProps {
  basePath: string // z.B. '/salon', '/stylist', '/admin'
  accentColor?: string // z.B. 'pink' für Stylist, 'purple' für Admin
}
...
export function SocialMediaDashboard({ basePath, accentColor = 'purple' }: SocialMediaDashboardProps) {
  ...
  const socialBasePath = `${basePath}/marketing/social-media`
          ...
          <Card className="border-dashed border-2 border-purple-500/30 bg-gradient-to-br from-purple-500/5 to-pink-500/5">
            <CardContent className="py-12 text-center">
              ...
              <Button asChild className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600">
                <Link href={`${socialBasePath}/accounts`}>
                  <Plus className="h-4 w-4 mr-2" />
                  Accounts verbinden
                </Link>
              </Button>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href={`${socialBasePath}/posts`}>
                  Alle anzeigen
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            ...
            <Button variant="outline" className="w-full justify-start" asChild>
              <Link href={`${socialBasePath}/templates`}>
            ...
            <Button variant="outline" className="w-full justify-start" asChild>
              <Link href={`${socialBasePath}/analytics`}>
