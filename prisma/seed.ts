...
async function main() {
  ...
  const emailTemplates = [
    ...
    },
    {
      ...
      description: 'Erinnerung 3 Tage vor Trial-Ende',
      subject: 'Deine Testphase endet in {{daysRemaining}} Tagen',
      content: {
        headline: 'Deine Testphase endet bald',
        body: 'deine kostenlose Testphase für {{planName}} endet am {{trialEndDate}}. Upgrade jetzt, um weiterhin alle Premium-Funktionen nutzen zu können.',
        buttonText: 'Jetzt upgraden',
        buttonUrl: '{{upgradeUrl}}',
        footer: 'Keine Sorge - deine Daten bleiben erhalten, wenn du upgradest!',
      },
      category: 'subscription',
      isSystem: true,
    },
    {
      ...
      name: 'Abo gekündigt',
      description: 'Bestätigung der Kündigung',
      subject: 'Dein Abo wurde gekündigt',
      content: {
        headline: 'Abo-Kündigung bestätigt',
        body: 'deine Kündigung wurde erfolgreich durchgeführt. Du kannst alle Funktionen noch bis zum {{endDate}} nutzen. Wir würden uns freuen, dich bald wieder bei uns begrüßen zu dürfen!',
        buttonText: 'Abo reaktivieren',
        buttonUrl: '{{reactivateUrl}}',
        footer: 'Solltest du es dir anders überlegen, kannst du dein Abo jederzeit wieder aktivieren.',
      },
      category: 'subscription',
      isSystem: true,
    },
