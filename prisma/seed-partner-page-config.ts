...
async function main() {
  ...
  await prisma.$queryRaw`
    INSERT INTO partner_page_config (
      ...
      'Exklusive Vorteile',
      'Nur für Mitglieder',
      'Exklusive Vorteile für NICNOA&CO.online Mitglieder',
      '/registrieren',
      'Jetzt Mitglied werden',
      'Werde Teil unserer Community',
      'Als NICNOA&CO.online Mitglied profitierst du von exklusiven Partner-Deals, Rabatten und Sonderangeboten.',
      'Jetzt registrieren',
      '/registrieren',
      'Preise ansehen',
      '/preise',
